...
#include "InventoryTutorialProjectile.h"
...
void AInventoryTutorialCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AInventoryTutorialCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AInventoryTutorialCharacter::TouchStarted);
	if (EnableTouchscreenMovement(PlayerInputComponent) == false)
	{
		PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AInventoryTutorialCharacter::OnFire);
	}
...
void AInventoryTutorialCharacter::OnFire()
{
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AInventoryTutorialProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
				...
				World->SpawnActor<AInventoryTutorialProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void AInventoryTutorialCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AInventoryTutorialCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AInventoryTutorialCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool AInventoryTutorialCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	bool bResult = false;
	if (FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		bResult = true;
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AInventoryTutorialCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AInventoryTutorialCharacter::EndTouch);
